                    ...
                    SizedBox(
                      ...
                      child: GetBuilder<HomeController>(builder: (_) {
                        ...
                        return ListView.builder(
                            shrinkWrap: true,
                            physics: const ScrollPhysics(),
                            itemCount: _.homeModelOne?.deals?.length == null
                                ? 0
                                : _.homeModelOne!.deals!.length >= 5
                                    ? 6
                                    : _.homeModelOne?.deals?.length,
                            scrollDirection: Axis.horizontal,
                            itemBuilder: ((context, index) {
                              if (index == 0) {
                                return Container(
                                  margin: const EdgeInsets.only(left: 8.0),
                                  child: card3(
                                      context, _.homeModelOne!.deals![index]),
                                );
                              }
                              if (index == _.homeModelOne!.deals!.length - 1) {
                                return Container(
                                  margin: const EdgeInsets.only(right: 18.0),
                                  child: card3(
                                      context, _.homeModelOne!.deals![index]),
